...
const ENGINEERING_SYSTEM_PROMPT = `Ты — упаковщик инженерных задач. На входе — описание задачи на русском с интерпретацией. Сформируй структурированный пакет выполнения как JSON (все поля на русском):
{
