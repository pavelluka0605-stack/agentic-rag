...
function kuhni_rema_options_acf_fields() {
    ...
    acf_add_local_field_group( array(
        ...
        'fields' => array(
            ...
            array(
                'key'           => 'field_global_company_name',
                'label'         => 'Юридическое наименование',
                'name'          => 'global_company_name',
                'type'          => 'text',
                'instructions'  => 'Для политики конфиденциальности (152-ФЗ)',
                'wrapper'       => array( 'width' => '50' ),
            ),
            array(
                'key'     => 'field_global_company_inn',
                'label'   => 'ИНН',
                'name'    => 'global_company_inn',
                'type'    => 'text',
                'wrapper' => array( 'width' => '25' ),
            ),
            array(
                'key'     => 'field_global_company_ogrn',
                'label'   => 'ОГРН',
                'name'    => 'global_company_ogrn',
                'type'    => 'text',
                'wrapper' => array( 'width' => '25' ),
            ),
            array(
                'key'           => 'field_global_logo_text',
                'label'         => 'Текст логотипа',
                'name'          => 'global_logo_text',
                'type'          => 'text',
                'default_value' => 'Кухни Рема',
                'instructions'  => 'Текст, отображаемый рядом с логотипом',
                'wrapper'       => array( 'width' => '50' ),
            ),
            array(
                'key'           => 'field_analytics_ym_counter_id',
                'label'         => 'ID счётчика Яндекс Метрики',
                'name'          => 'analytics_ym_counter_id',
                'type'          => 'text',
                'instructions'  => 'Числовой ID счётчика для отслеживания конверсий',
                'wrapper'       => array( 'width' => '50' ),
            ),
        ),
        'location' => array(
